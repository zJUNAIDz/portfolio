...
// LinkedIn is not available in simple-icons (removed for trademark reasons),
// so it is provided here as a local SVG component.
export function Linkedin(props: React.SVGAttributes<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24}
      fill={"currentColor"} viewBox="0 0 24 24" {...props}>
...
// Brand icons (Github, Instagram, Twitter/X) were removed from lucide-react in
// v1, so they are sourced from simple-icons. These default to `currentColor`,
// keeping the monochrome look.
export {
  SiGithub as Github,
